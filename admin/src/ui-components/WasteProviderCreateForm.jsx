...
export default function WasteProviderCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new WasteProvider(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WasteProviderCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
